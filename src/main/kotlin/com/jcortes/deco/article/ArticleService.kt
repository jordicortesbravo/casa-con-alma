...
import com.jcortes.deco.article.infrastructure.bedrock.BedrockTextClient
import com.jcortes.deco.article.infrastructure.bedrock.BedrockTextInferenceRequest
import com.jcortes.deco.article.model.*
import com.jcortes.deco.tools.util.bedrock.BedrockTextModel
import com.jcortes.deco.image.ImageService
import com.jcortes.deco.image.model.*
...
class ArticleService(
    ...
    fun search(
        ...
        val request = SearchArticleRequest(embedding = embedding, siteCategories = siteCategories, tags = tags, status = status, pageSize = pageable.pageSize, pageNumber = pageable.pageNumber)
        return articleRepository.search(request)
    }
