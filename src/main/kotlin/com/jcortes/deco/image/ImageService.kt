...
import com.jcortes.deco.image.infrastructure.bedrock.BedrockImageClient
import com.jcortes.deco.image.infrastructure.bedrock.BedrockImageInferenceRequest
...
//            throw e
    ...
    fun generate(prompt: String, imageModel: BedrockImageModel? = null): Image {
